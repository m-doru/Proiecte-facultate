/*
 * File: _coder_genereazaPuncteCaroiaj_api.c
 *
...
emlrtContext emlrtContextGlobal = { true, false, 131434U, NULL,
  "genereazaPuncteCaroiaj", NULL, false, { 2045744189U, 2170104910U, 2743257031U,
    4284093946U }, NULL };

/* Function Declarations */
static void b_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u, const
  emlrtMsgIdentifier *parentId, emxArray_uint8_T *y);
static int32_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *nrPuncteX,
  ...
  const char_T *identifier)
{
  ...
  y = d_emlrt_marshallIn(sp, emlrtAlias(nrPuncteX), &thisId);
  emlrtDestroyArray(&nrPuncteX);
  return y;
}
...
static void e_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src, const
  emlrtMsgIdentifier *msgId, emxArray_uint8_T *ret)
{
  static const int32_T dims[3] = { 1000, 1000, 3 };
 ...
 * Return Type  : void
 */
void genereazaPuncteCaroiaj_api(const mxArray *prhs[4], const mxArray *plhs[1])
{
  ...
  emxInit_real_T(&st, &puncteCaroiaj, 2, true);
  prhs[0] = emlrtProtectR2012b(prhs[0], 0, false, -1);

  /* Marshall function inputs */
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "img", img);
  nrPuncteX = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[1]), "nrPuncteX");
  nrPuncteY = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "nrPuncteY");
  margine = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[3]), "margine");

  /* Invoke the target function */
  genereazaPuncteCaroiaj(img, nrPuncteX, nrPuncteY, margine, puncteCaroiaj);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(puncteCaroiaj);
  puncteCaroiaj->canFreeData = false;
  emxFree_real_T(&puncteCaroiaj);
 ...
 * Return Type  : void
 */
void genereazaPuncteCaroiaj_atexit(void)
{
  emlrtStack st = { NULL, NULL, NULL };
  ...
  genereazaPuncteCaroiaj_xil_terminate();
}
 ...
 * Return Type  : void
 */
void genereazaPuncteCaroiaj_initialize(void)
{
  emlrtStack st = { NULL, NULL, NULL };
 ...
 * Return Type  : void
 */
void genereazaPuncteCaroiaj_terminate(void)
{
  emlrtStack st = { NULL, NULL, NULL };
...
/*
 * File trailer for _coder_genereazaPuncteCaroiaj_api.c
 *
 * [EOF]
 */
